...
if automatic=='No' | automatic=='NO' | automatic=='no'
    ...
    paciente='Paciente8_FlorenciaIgnacio'
    paradigma='Integracion'
    archivo='Paciente8_Integracion_faces'
...
EEG=import_set(archivo,path,channel); %Paciente5
...
file='Paciente8_MarioWM_Faces'
sheet='Paciente8_MarioWM_face.'
...
trial_time(:,3)=make_logtimevector(path,file,sheet,Range4);
trial_time(:,4)=make_logtimevector(path,file,sheet,Range5);
