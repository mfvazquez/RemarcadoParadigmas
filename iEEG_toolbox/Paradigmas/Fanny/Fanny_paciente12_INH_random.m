...
path=[path_file 'Motor_Inhibition_random_2.edf' ];
channel=8;  
...
mat_file1=[path '17RandomSequenceBlock1.mat'];
load (mat_file1);

stimuli_time=stimTrigSentTime+0.12; %0.12
stimuli_time=stimuli_time(1:100, 1);
tr=keyPressTime+0.12;
tr=keyPressTime(1:100, 1);
