...
path_file=['D:\Fabri\Pacientes\Paciente12_LB\Masters\DVT\'];
   
path=[path_file 'Paciente12_DVT.edf' ];
channel=8;  
...
name='DVT_Paciente12.xls';
sheet='hoja1'


path_file=['D:\Fabri\Pacientes\Paciente12_LB\Logs\DVT\'];

% [trial_mark]=make_logmarkvector(path_file,name, sheet, range);

range='C2:C361' %Se perdió el primer trial
