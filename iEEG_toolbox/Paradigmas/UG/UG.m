...
EEG=import_edf([path paciente '_2.edf'],channel); %Paciente5_2
...
name=[paciente '_' paradigma '2.xls']
sheet=[paciente '_' paradigma '2']
range= ['G11:G202']
path_log=[path 'logfiles\'];
...
range= ['C11:C202']
trial_time_full.performance=read_xls2(path_log,name, sheet, range);
